package com.example.projectInternRampUp.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<String> handleException(HttpMessageNotReadableException exception, HttpServletRequest request) {
        return new ResponseEntity("JSON Parse Error: Field has incorrect or empty value", HttpStatus.BAD_REQUEST);
    }
}